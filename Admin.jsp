...
<body>
	 <div align="center">
	  ...
	  <hr style="background:black;">
	    ...
	    <input type="tel" placeholder="Admin ID" name="uname" maxlength="7" required>
	    <br>
	    ...
	    <div class="container1">
	      <input  type="checkbox"  name="remember"> Keep in Mind<span class="psw"><a 
